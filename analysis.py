...
class Analysis:
    ...
    def __init__(self, result_dir):
        ...
        self.granularity_types = ['delay', 'delay, jitter', 'delay, jitter, packet-loss']
    ...
    def draw_result_granularity(self):
        ...
        results = []
        for i in range(3):
            results.append(self.read_result('RLQ%d.txt' % (i+1)))
...
if __name__ == '__main__':
    ...
    # analysis = Analysis('results_granu/')
    # analysis.draw_result_granularity()
